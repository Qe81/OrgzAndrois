package com.example.orgzandrois.Week;
        ...
        if (mDateTimeInterpreter == null) {
            mDateTimeInterpreter = new DateTimeInterpreter() {
                ...
                public String interpretDate(Calendar date) {
                    try {
                        SimpleDateFormat sdf = mDayNameLength == LENGTH_SHORT ? new SimpleDateFormat("EEEEE M/dd", new Locale("uk", "UA")) : new SimpleDateFormat("EEE M/dd", new Locale("uk", "UA"));
